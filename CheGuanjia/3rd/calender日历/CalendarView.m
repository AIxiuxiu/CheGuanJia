...
@property (nonatomic, assign) NSInteger dayHeighth;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _dayHeighth                 = frame.size.width/10;
...
//        [_gregorian setTimeZone: timeZone];
        ...
        _defaultFont                = [UIFont fontWithName:@"HelveticaNeue" size:16.0f];
        _titleFont                  = [UIFont fontWithName:@"Helvetica-Bold" size:18.0f];
...
//    NSInteger minY = _originY + _dayWidth;
    NSInteger maxY = _originY + _dayHeighth * (NSInteger)(1+(monthLength+weekdayBeginning)/7) + ((remainingDays !=0)? _dayHeighth:0);
...
//    CGContextAddRect(context, CGRectMake(_originX + 7*_dayWidth - _borderWidth/2.f, minY - _borderWidth/2.f, _borderWidth, maxY - minY));
    ...
    UIButton * buttonPrev          = [[UIButton alloc] initWithFrame:CGRectMake(_originX, 0, _dayWidth, _dayHeighth)];
    ...
    UIButton * buttonNext          = [[UIButton alloc] initWithFrame:CGRectMake(self.bounds.size.width - _dayWidth - _originX, 0, _dayWidth, _dayHeighth)];
    ...
    // Day labels
    __block CGRect frameWeekLabel = CGRectMake(0, _originY, _dayWidth, _dayHeighth);
    ...
    for (NSInteger i= 0; i<monthLength; i++)
    {
        ...
        NSInteger offsetY   = (_dayHeighth *((i+weekdayBeginning)/7));
        UIButton *button    = [self dayButtonWithFrame:CGRectMake(_originX+offsetX, _originY+_dayHeighth+offsetY, _dayWidth, _dayHeighth)];
    ...
    for (int i=0; i<weekdayBeginning; i++)
    {
        ...
        NSInteger offsetY               = (_dayHeighth *(i/7));
        UIButton *button                = [self dayButtonWithFrame:CGRectMake(_originX+offsetX, _originY + _dayHeighth + offsetY, _dayWidth, _dayHeighth)];
    ...
    for (NSInteger i=remainingDays; i<7; i++)
    {
        ...
        NSInteger offsetX               = (_dayWidth*((i) %7));
        NSInteger offsetY               = (_dayHeighth *((monthLength+weekdayBeginning)/7));
        UIButton *button                = [self dayButtonWithFrame:CGRectMake(_originX+offsetX, _originY + _dayHeighth + offsetY, _dayWidth, _dayHeighth)];
