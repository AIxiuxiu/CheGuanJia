...
@interface CarListDetailViewController ()<UIScrollViewDelegate,UITextFieldDelegate,ZHPickViewDelegate,UIAlertViewDelegate>
...
@implementation CarListDetailViewController
{
    BOOL _up;
    UILabel *_recLiLab;
    UILabel *_buyCarTime;
...
- (void)viewDidLoad {
    ...
    self.titLab.text = @"爱车详情";
    
//    UIButton *sureBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH- 40, 25, 40, 30)];
...
-(void)initView
{
    ...
    [photoImg setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/photo/CarBrand/%@",Main_Ip, self.passCar.photo]] placeholderImage:[UIImage imageNamed:@"photoNo"]];
    [infoView addSubview:photoImg];
    UILabel *nameLab = [[UILabel alloc] initWithFrame:CGRectMake(98, 20, SCREEN_WIDTH-68, 30)];
    nameLab.text = [NSString stringWithFormat:@"%@ %@ %@",self.passCar.carbrand,self.passCar.carseries,self.passCar.caryear];;
    ...
    typeLab.text = [NSString stringWithFormat:@"%@",self.passCar.carmodel];
    ...
    NSString *str = [self.passCar.licenseID substringToIndex:1];
    [_areaBtn setTitle:[NSString stringWithFormat:@"%@",str] forState:UIControlStateNormal];
    ...
    NSString *chepaiStr = [self.passCar.licenseID substringWithRange:NSMakeRange(1,6)];
    chepaiTF.placeholder = chepaiStr;
    ...
    chejiaTF.placeholder = [NSString stringWithFormat:@"%@",self.passCar.frameID];
...
//    [chejiaView addSubview:helpBtn];
    ...
    _LiTF1 = [[UITextField alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-140, 10, 80, 30)];
    _LiTF1.textColor = RGBACOLOR(237, 65, 53, 1);
    _LiTF1.textAlignment = NSTextAlignmentRight;
    _LiTF1.placeholder = [NSString stringWithFormat:@"%@",self.passCar.mileage];
    ...
    _buyCarTime.text = [NSString stringWithFormat:@"%@",self.passCar.buytime];
    ...
    _LiTF2 = [[UITextField alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-140, 10, 80, 30)];
    _LiTF2.textColor = RGBACOLOR(237, 65, 53, 1);
    _LiTF2.textAlignment = NSTextAlignmentRight;
    _LiTF2.placeholder = [NSString stringWithFormat:@"%@",self.passCar.maintenanceMileage];
    ...
    _lastBaoTime.text = [NSString stringWithFormat:@"%@",self.passCar.maintenanceTime];
