...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.timeLab.frame)+15, SCREEN_WIDTH-15, 1)];
        line1.backgroundColor = [UIColor lightGrayColor];
        [self addSubview:line1];
        
        UIImageView *photoImg = [[UIImageView alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(line1.frame)+8, 20, 20)];
        photoImg.image = [UIImage imageNamed:@"shangjia"];
        ...
        self.goodBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-140, CGRectGetMaxY(line1.frame)+5, 60, 30)];
        [self.goodBtn setTitle:@"满意" forState:UIControlStateNormal];
        [self.goodBtn setTitleColor:[UIColor whiteColor] forState:0];
        self.goodBtn.layer.cornerRadius = 5;
        self.goodBtn.backgroundColor = COLOR_RED;
        [self addSubview:self.goodBtn];
        
        self.badBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-70, CGRectGetMaxY(line1.frame)+5, 60, 30)];
        [self.badBtn setTitle:@"不满意" forState:UIControlStateNormal];
        [self.badBtn setTitleColor:[UIColor whiteColor] forState:0];
        self.badBtn.layer.cornerRadius = 5;
        self.badBtn.backgroundColor = [UIColor grayColor];
